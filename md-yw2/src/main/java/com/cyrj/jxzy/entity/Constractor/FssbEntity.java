...
@ApiModel(value = "附属设备")
public class FssbEntity extends BaseEntity{
	@ApiModelProperty(value="环保设备id")
	private String fssbid;//环保设备id
	...
	private String arr;
	private List<FssbEntity> entity_list;
	public String getFssbid() {
		return fssbid;
	}
	public void setFssbid(String fssbid) {
		this.fssbid = fssbid;
	}
	...
	public List<FssbEntity> getEntity_list() {
		return entity_list;
	}
	public void setEntity_list(List<FssbEntity> entity_list) {
		this.entity_list = entity_list;
	}
	@Override
	public String toString() {
		return "FssbEntity [fssbid=" + fssbid + ", oilfield=" + oilfield
				...
				+ ", fileurl=" + fileurl + ", fileurl2=" + fileurl2
				+ ", filename=" + filename
				+ ", fileFileName=" + Arrays.toString(fileFileName) + ", arr="
				+ arr + ", entity_list=" + entity_list + "]";
	}
